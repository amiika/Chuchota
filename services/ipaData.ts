...
export interface KlattFrame {
    ...
    isVowel?: boolean;      // For duration rules
    isVoiced?: boolean;     // For duration rules
...
const DEFAULTS: KlattFrame = {
    isNasal: false, isStop: false, isVowel: false, isVoiced: false,
...
export const IPA_DATA: Record<string, KlattFrame> = {
    'I': d({
        isVowel: true, isVoiced: true, voiceAmplitude: 1.0, baseDuration: 130,
    ...
    'æ': d({
        isVowel: true, isVoiced: true, voiceAmplitude: 1.0, baseDuration: 200,
    ...
    'b': d({
        isStop: true, isVoiced: true, voiceAmplitude: 1.0, baseDuration: 30,
        parallelBypass: 0.1, 
    ...
    'd': d({
        isStop: true, isVoiced: true, voiceAmplitude: 1.0, fricationAmplitude: 0.1, baseDuration: 30,
    ...
    'k': d({
        isStop: true, isVoiced: false, fricationAmplitude: 0.15, baseDuration: 30,
    ...
    'p': d({
        isStop: true, isVoiced: false, fricationAmplitude: 0.4, parallelBypass: 0.15, baseDuration: 30,
    ...
    't': d({
        isStop: true, isVoiced: false, fricationAmplitude: 0.1,
    ...
    'm': d({
        isNasal: true, isVoiced: true, voiceAmplitude: 1.0, caNP: 1.0, baseDuration: 70,
    ...
    'ɛ̃': d({
        isNasal: true, isVoiced: true, voiceAmplitude: 1.0, caNP: 1.0, baseDuration: 130,
    ...
    'l': d({
        isVoiced: true, voiceAmplitude: 1.0, baseDuration: 70,
    ...
    'ɾ': d({
        isVoiced: true, voiceAmplitude: 1.0,
    ...
    'ʁ': d({
        isVoiced: true, voiceAmplitude: 0.8, fricationAmplitude: 0.3, baseDuration: 70,
    ...
    'f': d({
        isVoiced: false, fricationAmplitude: 0.3, parallelBypass: 0.1, baseDuration: 80,
    ...
    'h': d({
        isVoiced: false, aspirationAmplitude: 1.0, copyAdjacent: true, baseDuration: 80,
    }),
    's': d({
        isVoiced: false, fricationAmplitude: 0.3, baseDuration: 80,
    ...
    'ʃ': d({
        isVoiced: false, fricationAmplitude: 0.25, baseDuration: 80,
    ...
    'θ': d({
        isVoiced: false, fricationAmplitude: 0.15, parallelBypass: 0.1, baseDuration: 80,
    ...
    'v': d({
        isVoiced: true, voiceAmplitude: 1.0, fricationAmplitude: 0.1, parallelBypass: 0.05, baseDuration: 60,
    ...
    'z': d({
        isVoiced: true, voiceAmplitude: 1.0, fricationAmplitude: 0.3, baseDuration: 60,
    ...
    'ð': d({
        isVoiced: true, voiceAmplitude: 0.3, fricationAmplitude: 0.18, parallelBypass: 0.66,
        cf1: 270, cf2: 1290, cf3: 2540, cf4: 3300, cf5: 3750, cf6: 4900,
        cb1: 66, cb2: 60, cb3: 127.5, cb4: 250, cb5: 200, cb6: 1000,
        cfNP: 200, cbNP: 100, cfN0: 250, cbN0: 100,
        pf1: 270, pf2: 1290, pf3: 2540, pf4: 3300, pf5: 3750, pf6: 4900,
        pb1: 60, pb2: 80, pb3: 170, pb4: 250, pb5: 200, pb6: 1000,
        pa6: 0.46, baseDuration: 60
    }),
    'ʒ': d({
        isVoiced: true, voiceAmplitude: 0.3, fricationAmplitude: 0.05,
