...
export const PERSONAS: Record<string, VoiceConfig> = {
    ...
    "Robot": {
        pitch: 120, speed: 1.0, throat: 1.0, mouth: 0.5, tongue: 1.0,
    ...
    "Slither": {
        pitch: 70, speed: 1.0, throat: 1.8, mouth: 0.7, tongue: 0.9,
